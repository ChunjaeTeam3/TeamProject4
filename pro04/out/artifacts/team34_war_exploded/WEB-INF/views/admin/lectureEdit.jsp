    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="container mt-100 mb-100">
                <h2> 강의 정보 수정 <i class="fa-solid fa-feather"></i> </h2>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <select id="scode" name="scode" class="form-select">
                                    <c:forEach var="subject" items="${subjects}">
                                        <c:if test="${subject.scode eq detail.scode}">
                                            <option value="${subject.scode}" selected> ${subject.sname} </option>
                                        </c:if>
                                        <c:if test="${subject.scode ne detail.scode}">
                        ...
                        <div class="col">
                            <div class="form-group mt-3">
                                ...
                                <input type="text" name="lname" id="lname" class="form-control" autocomplete="off" value="${detail.lname}" required>
                                <input type="hidden" name="lcode" id="lcode" value="${detail.lcode}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group mt-3">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <select class="custom-select" id="tcode" name="tcode" size="8" required>
                            <c:forEach var="teacher" items="${teachers}">
                                ...
                                <c:if test="${teacher.tcode ne detail.tcode}">
                        ...
                        <div class="col">
                            <div class="form-group mt-3">
                                <div class="form-group mt-3">
                                    ...
                                    <input type="number" min="0" name="maxStudent" id="maxStudent" class="form-control" value="${detail.maxStudent}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="form-group mt-3">
                                ...
                                <input type="date" name="sdate" id="sdate" class="form-control" placeholder="시작일을 지정해주세요" autocomplete="off" value="${detail.sdate}" required>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group mt-3">
                                <label class="edate">종료일</label>
                                <input type="date" name="edate" id="edate" class="form-control" placeholder="종료일을 지정해주세요" autocomplete="off" value="${detail.edate}" required>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group mt-3">
                                <label class="stime">시작시간</label>
                                <input type="time" name="stime" id="stime" class="form-control" placeholder="시작시간을 지정해주세요" autocomplete="off" value="${detail.stime}" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group mt-3">
                                ...
                                <input type="text" name="classroom" id="classroom" class="form-control" value="${detail.classroom}" autocomplete="off" disabled>
                            </div>
                        </div>
                    </div>
