...
<div class="container-lg" style="margin: 100px auto; width: 85%;">
    ...
    <!-- section2(online Table) Start -->
    <div class="row" style="width: 85%; margin: 0 auto; padding-bottom: 50px;">
        <div class="row">
            <h5><i class="fa-solid fa-desktop" style="color: #000000; padding-right: 15px;"></i>온라인 수강내역</h5>
        </div>
    ...
    <!-- section2(online Table) End -->

    <!-- section3(offline Table) Start -->
    <div class="row" style="width: 85%; margin: 0 auto; padding-bottom: 50px;">
        <div class="row">
            <h5><i class="fa-solid fa-chalkboard-user" style="color: #000000; padding-right: 15px"></i>오프라인 수강내역</h5>
        </div>
        <div class="col-lg-12" style="width: 100%;">
            <div class="card">
                <div class="card-body">
